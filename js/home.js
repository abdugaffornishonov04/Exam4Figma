...
const ratingChange = document.getElementById( "rating-change-imgs");
function ratingChanger(){
  if ( ratingChange.src == "./images/starfill.svg"){
    ratingChange.src = "./images/starhalfempty.svg"
  }
}

ratingChange.addEventListener("click",ratingChanger)
